    ...
    <div class="page-wrap bg-gray p10">
        <div class="container p10 bg-white">
            ...
            <div class="board_insert">
                <form enctype="multipart/form-data" method="POST" action="${pageContext.request.contextPath}/article/grp_article_reply">
                ...
                <input type="hidden" name="aid" value="${view.aid}" />
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="td-90 p-lr3" colspan="3">
                                <input value="[답글] ${view.subject}" name="subject" type="text" class="input-100" maxlength="100" required />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="btn-grp center m-t10">
                        <button type="submit" class="btn-normal">답글 작성</button>
