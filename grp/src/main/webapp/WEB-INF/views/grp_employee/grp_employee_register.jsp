					...
					<div class="page-main-wrap">
						...
						<div class="page-member-bottom">
							<div class="page-content">
								<form id="frm" method="POST" autocomplete="off" action="${pageContext.request.contextPath}/employee/grp_admin_register" enctype="multipart/form-data">
										...
										<div class="member-right">
											<table>
												<tr>
													...
													<td class="td-13 p-lr3">
													<select name="empBuseoCode" id="empBuseoCode" class="sel-135" required >
													</select>
													</td>
													<td class="td-7 center under bg-gray weight700">직급</td>
													<td class="td-13 p-lr3">
													<select name="empGradeCode" id="empGradeCode" class="sel-135" required>
													</select>
													</td>
													<td class="td-7 center under bg-gray weight700">입사년월</td>
													<td class="td-13 p-lr3">
													<input type="date" max="2020-12-31" min="1970-01-01" name="empEnter" id="empEnter" class="input-135" />
													</td>
													<td class="td-7 center under bg-gray weight700">비밀번호</td>
													<td class="td-13 p-lr3">
														<input type="text" name="empPwd" id="empPwd" class="input-135" maxlength="12" required/>
													</td>
												</tr>
												<tr>
													<td class="td-7 center under bg-gray weight700">사원명/성별</td>
													<td class="td-13 p-lr3">
													<input type="text" name="empName" id="empName" class="input-75" maxlength="10" required/>
